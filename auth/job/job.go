...
type IRIJob struct {
	...
	AttachToTangleRequest *gepo.AttachToTangleRequest  `json:"attachToTangleRequest,omitempty" datastore:",noindex"`
	AttachToTangleRespose *gepo.AttachToTangleResponse `json:"attachToTangleResponse,omitempty" datastore:",noindex"`
