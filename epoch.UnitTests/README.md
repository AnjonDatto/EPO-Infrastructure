...
This project is a work in progress, aiming to provide unit test coverage for the core epo code.
...
OR
With .NET Core SDK installed, use the CLI to navigate to the epo.UnitTest folder and use the command 'dotnet restore' to get packages, followed by 'dotnet test' to run tests.
